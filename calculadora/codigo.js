...
window.addEventListener("load",() =>{
    ...
    const botones = document.getElementsByClassName("boton")/* usar querySelector para que nos de el elemento solo */
    const result = document.querySelector(".resultado")
    /* Convierto la HTMLCollection a Array para poder iterar */const botonlista = Array.from(botones)
